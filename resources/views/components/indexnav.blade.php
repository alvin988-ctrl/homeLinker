...
>
    ...
    >
        <a href="{{ route('dashboard') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400">Home</a>
        ...
        <a href="{{ route('contactLogin') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400">Contact Us</a>
        <form action="{{route('logout')}}" method="Post">
                    @csrf
                    <button type="submit" class="text-gray-700 transition-colors duration-300 transform lg:mx-8 dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500" href="">Sign Out</button> </form>
