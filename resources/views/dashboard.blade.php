        ...
        <div class="max-w-lg mx-auto">
            ...
            <form class="max-w-sm mx-auto mt-6" action="{{ route('searchGuest') }}" method="GET">
                <input type="text" id="search" name="search" value="{{ request('search') }}"
                    placeholder="Search Properties by type & location"
...
@endif
    ...
    <!-- Grid: 3 columns on medium screens and above -->
    ...
    <div class="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex gap-1">
        <template x-for="(image, index) in {{ count($property->images) }}" :key="index">
            ...
            <div class="p-4">
                ...
                <div class="font-semibold absolute right-3 py-1 text-dark bg-neutral-primary-soft rounded-full text-sm">
                ...
                <div class="mt-4 flex items-center justify-between text-sm text-gray-500">
                    ...
                    <form action="{{ route('cardview', $property->id) }}" method="GET">
